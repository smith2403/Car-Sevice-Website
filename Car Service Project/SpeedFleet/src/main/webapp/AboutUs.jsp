	...
	<section class="hero">
		...
		<div class="container">
			<div class="hero-content">
				...
				<p>At SpeedFleet, we are dedicated to providing innovative
					solutions that meet your needs. With years of experience in the
					industry, we pride ourselves on delivering high-quality services
					that exceed expectations.</p>
				<button class="button">Learn More</button>
			</div>
			<div class="hero-image">
				<img src="images/mechanic.jpg" alt="Error">
			</div>
		</div>
	</section>
