    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="hero-content">
                <h2>Login Here</h2>
                <p>Discover the convenience of accessing our premium car services as a registered user. Experience
                    seamless vehicle management and exclusive offers tailored just for you.</p>
            ...
            <div class="hero-image">
                <img src="images/login.jpg" alt="Error">
            </div>
        </div>
    </section>
