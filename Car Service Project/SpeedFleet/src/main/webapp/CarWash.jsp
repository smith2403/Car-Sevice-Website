	...
	<section class="hero">
		...
		<div class="container">
			<div class="hero-content">
				<form class="wash-form" action="CarWash" method="POST">
				<div class="error-message">
					...
					<label for="name">Name</label> <input type="text" id="name"
						name="name" placeholder="eg.Smith Kinny" required> <label
						for="vehicleNumber">Vehicle Number</label> <input type="text"
						id="vehicleNumber" name="vehicleNumber"
						placeholder="eg.MH47BC2411" required> <label
						for="vehicleModel">Vehicle Model</label> <input type="text"
						id="vehicleModel" name="vehicleModel" placeholder="eg.Toyota"
						required> <label for="washType">Wash Type</label> <select
						id="washType" name="washType" required>
						<option value="basic">Basic Wash</option>
						<option value="premium">Premium Wash</option>
						<option value="deluxe">Deluxe Wash</option>
					</select> <label for="location">Location</label> <input type="text"
						id="location" name="location" placeholder="Your Location" required>

					<label for="price">Location</label> <input type="number" id="price"
			...
			<div class="hero-image">
				<img src="images/washForm.jpg" alt="Error">
			</div>
		</div>
	</section>
